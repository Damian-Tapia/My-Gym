...
export function Stepper({ value = 0, min = 0, max = 999, step = 1, unit, size = 'md', onChange, style, ...rest }) {
  ...
  return (
    <div {...rest} style={{ display: 'inline-flex', alignItems: 'center', gap: big ? 16 : 10, ...style }}>
      ...
      <span style={{ minWidth: big ? 96 : 64, textAlign: 'center', font: 'var(--text-metric)', fontSize: big ? 'var(--fs-metric-xl)' : 'var(--fs-metric)', color: 'var(--text-primary)', fontVariantNumeric: 'tabular-nums' }}>
