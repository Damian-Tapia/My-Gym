...
export function OptionRow({ title, subtitle, icon, selected = false, multi = false, disabled = false, onClick, style, ...rest }) {
  return (
    <button type="button" disabled={disabled} onClick={onClick} {...rest}
      style={{ display: 'flex', alignItems: 'center', gap: 12, width: '100%', textAlign: 'left', padding: '14px 16px',
      ...
      <span style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: 22, height: 22, flex: '0 0 auto',
