...
export function TabBar({ tabs = DEFAULT_TABS, value = 'home', onChange, style, ...rest }) {
  return (
    <nav {...rest} style={{ display: 'flex', alignItems: 'stretch', height: 'var(--tabbar-height)', paddingBottom: 4,
