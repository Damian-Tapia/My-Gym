...
export function IconButton({
  ...
  style,
  ...rest
}: IconButtonProps & Omit<React.ButtonHTMLAttributes<HTMLButtonElement>, keyof IconButtonProps>) {
  ...
  const skin = active
    ? { background: 'var(--surface-accent-soft)', color: 'var(--text-accent)', border: '1px solid var(--border-accent)' }
